...
DATADIR = "./Desktop/BDP/predict4/AQI/data"
 # data directory
...
sc.addPyFile("Desktop/BDP/predict4/AQI/pyspark_csv.py")
...
if __name__ == "__main__":
    ...
    train = train.select('TAQI', 'Temp Arithmetic Mean', 'Wind SpeedArithmetic Mean',
    ...
    submit = sqlCtx.createDataFrame(testNumber.zip(pred), ["Number", "TAQI"])
    """
