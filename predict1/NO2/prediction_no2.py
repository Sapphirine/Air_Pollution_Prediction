...
DATADIR = "./Desktop/BDP/predict1/NO2/data"
 # data directory
...
sc.addPyFile("Desktop/BDP/predict1/NO2/pyspark_csv.py")
...
if __name__ == "__main__":
    ...
    train = train.select('NO2 AQI','CO AQI', 'O3 AQI', 'SO2 AQI')
    test = test.select('CO AQI', 'O3 AQI', 'SO2 AQI')
    ...
    submit = sqlCtx.createDataFrame(testNumber.zip(pred), ["Number", "NO2 AQI"])
    """
