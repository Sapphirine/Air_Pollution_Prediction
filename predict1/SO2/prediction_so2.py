...
DATADIR = "./Desktop/BDP/predict1/SO2/data"
 # data directory
...
sc.addPyFile("Desktop/BDP/predict1/SO2/pyspark_csv.py")
...
if __name__ == "__main__":
    ...
    train = train.select('SO2 AQI','NO2 AQI', 'O3 AQI', 'CO AQI')
    test = test.select('NO2 AQI', 'O3 AQI', 'CO AQI')
    ...
    submit = sqlCtx.createDataFrame(testNumber.zip(pred), ["Number", "SO2 AQI"])
    """
